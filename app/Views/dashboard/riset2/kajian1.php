                ...
                <div class="row">  
                  <div class="col-md-6">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="chart">
                          <canvas id="barChartKBB_L81321" style="min-height: 362px; height: 362px; max-height: 362px; max-width: 100%;"></canvas>
                        </div>
                      </div>
                      <!-- /.card-body -->
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="chart">
                          <canvas id="barChartPWK_L81321" style="min-height: 362px; height: 362px; max-height: 362px; max-width: 100%;"></canvas>
                        </div>
                      </div>
                      <!-- /.card-body -->
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="chart">
                          <canvas id="barChartKBB_PWK_L813" style="min-height: 362px; height: 362px; max-height: 362px; max-width: 100%;"></canvas>
                        </div>
                      </div>
                      <!-- /.card-body -->
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="chart">
                          <canvas id="barChartKBB_PWK_L821" style="min-height: 362px; height: 362px; max-height: 362px; max-width: 100%;"></canvas>
                        </div>
                      </div>
                      <!-- /.card-body -->
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="card">
                      <div class="py-3 px-3 d-flex justify-content-between border-bottom">
                        <h3 class="card-title">Persentase Piksel Labelling Menurut Kelas Tutupan Lahan Lokus Bandung Barat dan Purwakarta (Sentinel-2)</h3>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="chart">
                          ...
                          <div id="heatmapPWKL82013" style="min-height: 362px; height: 362px; max-height: 362px; max-width: 100%;"></div>
                        </div>
                      </div>
                      <!-- /.card-body -->
                    </div>
